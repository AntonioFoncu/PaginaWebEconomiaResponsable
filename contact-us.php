<?php
$to      = 'diarioeconomiaresponsable@gmail.com'; // Put in your email address here
$subject = "Tu Prestamo Personal Online Contacto"; // The default subject. Will appear by default in all messages. Change this if you want.
